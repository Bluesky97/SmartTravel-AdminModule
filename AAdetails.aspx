<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AAdetails.aspx.cs" Inherits="AAdetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <form action="/action_page.php">
        <div class="container">
            ...
            <asp:Image ID="imgAttraction" Width="350px" Height="250px" runat="server" />
            <br />

            <label for="AttractionName"><b>Attraction Name</b></label>
            <asp:TextBox ID="tbxAttractionName" runat="server"></asp:TextBox>
    ...
    <div class="auto-style1">
        <asp:GridView ID="gvTicket" runat="server" CellPadding="4" CssClass="table table-nonfluid .table-striped .table-condensed table-responsive" AutoGenerateColumns="False" ForeColor="#333333" GridLines="None" Width="920px" >
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
                <asp:BoundField DataField="ticketID" HeaderText="Ticket ID" ReadOnly="True" />
                <asp:BoundField DataField="type" HeaderText="Ticket Type" ReadOnly="True" />
