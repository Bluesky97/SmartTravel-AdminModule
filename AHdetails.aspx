<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AHdetails.aspx.cs" Inherits="AHdetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <form action="/action_page.php">
        <div class="container">
            ...
            <asp:Image ID="imgHotel" Width="350px" Height="250px" runat="server" />
            <br />

            <label for="HotelName"><b>Hotel Name</b></label>
            <asp:TextBox ID="tbxHotel" runat="server"></asp:TextBox>
            ...
            <label for="oh"><b>License</b></label>
    ...
    <div class="center">
        <asp:GridView ID="gvRoom" runat="server" CellPadding="4" CssClass="table table-nonfluid .table-striped .table-condensed table-responsive" AutoGenerateColumns="False" ForeColor="#333333" GridLines="None" Width="1000px" >
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
                <asp:BoundField DataField="RoomID" HeaderText="Room ID" ReadOnly="True" />
                ...
                <asp:BoundField DataField="RoomSize" HeaderText="Room Size" ReadOnly="True" />
                ...
                <asp:BoundField DataField="Pictures" HeaderText="Pictures" ReadOnly="True" />
            </Columns>
